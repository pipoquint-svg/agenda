...
-- 1. cadence belongs to the service;
-- 2. each service_employee availability range anchors its own series;
-- 3. employee/service OPEN exceptions anchor their own series and overlap is deduplicated;
-- 4. physical-resource availability only filters candidates and never generates/reanchors them.
