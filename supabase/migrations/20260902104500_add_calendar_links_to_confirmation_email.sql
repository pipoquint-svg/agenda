          ...
          <tr>
            <td style="padding:0 28px 24px 28px;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%; border-collapse:collapse; background-color:#FFF9F2; border:1px solid #E3DDD5; border-radius:8px;">
                <tr>
                  <td style="padding:18px 18px 8px 18px; font-family:Arial,Helvetica,sans-serif; font-size:15px; line-height:21px; font-weight:700; color:#292826;">Adicione sua reserva ao calendário</td>
                </tr>
                <tr>
                  <td style="padding:0 18px 14px 18px; font-family:Arial,Helvetica,sans-serif; font-size:12px; line-height:19px; color:#6D6862;">Escolha onde deseja salvar este compromisso.</td>
                </tr>
                <tr><td style="padding:0 18px 8px 18px;"><a href="https://www.blacksheepestudiocriativo.com.br/adicionar-calendario?provider=google&amp;code={{appointment.public_code}}" style="display:block; padding:12px 16px; border:1px solid #D6CFC7; border-radius:7px; font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:18px; font-weight:700; text-align:center; color:#292826; text-decoration:none; background-color:#FFFFFF;">Google Calendar</a></td></tr>
                ...
                <tr><td style="padding:0 18px 18px 18px;"><a href="https://www.blacksheepestudiocriativo.com.br/adicionar-calendario?provider=outlook&amp;code={{appointment.public_code}}" style="display:block; padding:12px 16px; border:1px solid #D6CFC7; border-radius:7px; font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:18px; font-weight:700; text-align:center; color:#292826; text-decoration:none; background-color:#FFFFFF;">Outlook</a></td></tr>
              </table>
            </td>
          </tr>
$calendar$;
  v_calendar_standalone text := $calendar$
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%; max-width:620px; margin:18px auto; border-collapse:collapse; background-color:#FFF9F2; border:1px solid #E3DDD5; border-radius:8px;">
  <tr><td style="padding:18px 18px 8px 18px; font-family:Arial,Helvetica,sans-serif; font-size:15px; line-height:21px; font-weight:700; color:#292826;">Adicione sua reserva ao calendário</td></tr>
  <tr><td style="padding:0 18px 14px 18px; font-family:Arial,Helvetica,sans-serif; font-size:12px; line-height:19px; color:#6D6862;">Escolha onde deseja salvar este compromisso.</td></tr>
  <tr><td style="padding:0 18px 8px 18px;"><a href="https://www.blacksheepestudiocriativo.com.br/adicionar-calendario?provider=google&amp;code={{appointment.public_code}}" style="display:block; padding:12px 16px; border:1px solid #D6CFC7; border-radius:7px; font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:18px; font-weight:700; text-align:center; color:#292826; text-decoration:none; background-color:#FFFFFF;">Google Calendar</a></td></tr>
  <tr><td style="padding:0 18px 8px 18px;"><a href="https://www.blacksheepestudiocriativo.com.br/adicionar-calendario?provider=apple&amp;code={{appointment.public_code}}" style="display:block; padding:12px 16px; border:1px solid #D6CFC7; border-radius:7px; font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:18px; font-weight:700; text-align:center; color:#292826; text-decoration:none; background-color:#FFFFFF;">Apple Calendar</a></td></tr>
  <tr><td style="padding:0 18px 18px 18px;"><a href="https://www.blacksheepestudiocriativo.com.br/adicionar-calendario?provider=outlook&amp;code={{appointment.public_code}}" style="display:block; padding:12px 16px; border:1px solid #D6CFC7; border-radius:7px; font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:18px; font-weight:700; text-align:center; color:#292826; text-decoration:none; background-color:#FFFFFF;">Outlook</a></td></tr>
</table>
...
begin
  for v_template in
    select id, html_template, body_template
  ...
  loop
    ...
    if position('/adicionar-calendario?provider=google' in coalesce(v_html, '')) = 0 then
      if position(v_footer_marker in coalesce(v_html, '')) > 0 then
        v_html := replace(v_html, v_footer_marker, v_calendar_row || E'\n' || v_footer_marker);
      else
        v_html := coalesce(v_html, '') || E'\n' || v_calendar_standalone;
      end if;
    end if;
