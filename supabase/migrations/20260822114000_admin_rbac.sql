-- Role/permission model for the BlackSheep administrative hub.
-- Authorization is enforced in backend helpers; UI visibility is secondary.
...
create or replace function public.service_admin_role_default_permission(
  p_role text,
  p_permission text
)
returns boolean
...
create or replace function public.service_admin_has_permission(
  p_admin_id uuid,
  p_permission text
)
returns boolean
