...
select is(
  ...
  9,
  'only eight public booking RPCs plus the explicitly protected admin appointment search are exposed'
);
...
select ok(
  ...
  'the eight public booking RPCs keep the expected anon/authenticated contract'
);
