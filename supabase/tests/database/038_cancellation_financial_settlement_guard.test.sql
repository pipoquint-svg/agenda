...
values
  ('11000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000000', 'authenticated', 'authenticated', 'owner-settlement@example.test', '', now(), now()),
  ('11000000-0000-4000-8000-000000000002', '00000000-0000-4000-8000-000000000000', 'authenticated', 'authenticated', 'operation-settlement@example.test', '', now(), now());
