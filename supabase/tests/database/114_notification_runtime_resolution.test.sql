...
values ('98100000-0000-0000-0000-000000000100','APPOINTMENT_APPROVED','EMAIL','CUSTOMER','GLOBAL',true);
select is((select title_template from public.resolve_notification_template('APPOINTMENT_APPROVED','EMAIL','CUSTOMER','98100000-0000-0000-0000-000000000010')),'GLOBAL','global template resolves');

insert into public.notification_template_configs(id,event_key,channel,audience,operation_scope,title_template,is_active)
values ('98100000-0000-0000-0000-000000000101','APPOINTMENT_APPROVED','EMAIL','CUSTOMER','BLACKSHEEP','OPERATION',true);
select is((select title_template from public.resolve_notification_template('APPOINTMENT_APPROVED','EMAIL','CUSTOMER','98100000-0000-0000-0000-000000000010')),'OPERATION','operation beats global');
...
values ('98100000-0000-0000-0000-000000000102','APPOINTMENT_APPROVED','EMAIL','CUSTOMER','BLACKSHEEP','98100000-0000-0000-0000-000000000001','CATEGORY',true);
select is((select title_template from public.resolve_notification_template('APPOINTMENT_APPROVED','EMAIL','CUSTOMER','98100000-0000-0000-0000-000000000010')),'CATEGORY','category beats operation');

insert into public.notification_template_configs(id,event_key,channel,audience,operation_scope,title_template,is_active)
values ('98100000-0000-0000-0000-000000000103','APPOINTMENT_APPROVED','EMAIL','CUSTOMER','BLACKSHEEP','SERVICE',true);
...
select is((select title_template from public.resolve_notification_template('APPOINTMENT_APPROVED','EMAIL','CUSTOMER','98100000-0000-0000-0000-000000000010')),'SERVICE','service beats category');
select is((select title_template from public.resolve_notification_template('APPOINTMENT_APPROVED','EMAIL','CUSTOMER','98100000-0000-0000-0000-000000000011')),'CATEGORY','service-scoped template does not leak to sibling service');

update public.notification_template_configs set is_active=false where id='98100000-0000-0000-0000-000000000102';
select is((select title_template from public.resolve_notification_template('APPOINTMENT_APPROVED','EMAIL','CUSTOMER','98100000-0000-0000-0000-000000000011')),'OPERATION','inactive category template is ignored');
