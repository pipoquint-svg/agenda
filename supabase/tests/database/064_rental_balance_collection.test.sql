...
insert into public.appointments(
 ...
 '96500000-0000-0000-0000-000000000012','BAL-OLD-FULL','96500000-0000-0000-0000-000000000005','96500000-0000-0000-0000-000000000006','Locação BlackSheep','96500000-0000-0000-0000-000000000007','CONFIRMED','UNPAID_AUTHORIZED',
...
select is(public.enqueue_due_rental_balance_collections(),1,'automatic worker does not lose an eligible balance only because service start is older than 24 hours');
select is((select amount_snapshot from public.appointment_balance_collections where appointment_id='96500000-0000-0000-0000-000000000012'),1000.00::numeric,'automatic collection also covers a fully unpaid checkout balance');
