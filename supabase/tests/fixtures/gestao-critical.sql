...
-- Loaded only in the local Supabase stack created by the test runner.
...
insert into public.services (
  ...
  checkout_hold_minutes, payment_hold_minutes, allow_reschedule, allow_cancel,
  requires_terms, is_active, operation_scope
) values (
  '99000000-0000-0000-0000-000000000010',
  '99000000-0000-0000-0000-000000000003',
  'QA Reserva Crítica', 'qa-reserva-critica', 60, 100,
  1, 4, 5000, 30, 1440, true, true, false, true, 'BLACKSHEEP'
);
