...
MODE_MARKERS: dict[str, list[list[str]]] = {
    ...
    "dracma_finance_secret": [["x-dracma-finance-secret"], ["DRACMA_FINANCE_REFERENCE_SECRET"]],
    ...
    "infinitepay_return_check": [["parseInfinitePayRedirectSignal"], ["checkInfinitePayPayment"], ["verifyInfinitePayPayment"]],
