...
def main() -> int:
    ...
    require(manifest.get("production_baseline", {}).get("active_total") == 67, "ACTIVE_TOTAL_NOT_UPDATED", errors)
    require(manifest.get("production_baseline", {}).get("verify_jwt_false") == 52, "JWT_FALSE_COUNT_NOT_UPDATED", errors)
    require(manifest.get("production_baseline", {}).get("versioned_active") == 62, "VERSIONED_ACTIVE_COUNT_NOT_UPDATED", errors)
