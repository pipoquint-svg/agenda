...
export const mapEmployeeBlockingCalendar=(employeeId:string,calendarId:string,token:string)=>request(token,{method:'PUT',body:JSON.stringify({action:'BLOCKING_CALENDAR_MAP',employee_id:employeeId,google_calendar_id:calendarId})})
export const unmapEmployeeBlockingCalendar=(employeeId:string,calendarId:string,token:string)=>request(token,{method:'PUT',body:JSON.stringify({action:'BLOCKING_CALENDAR_UNMAP',employee_id:employeeId,google_calendar_id:calendarId})})
