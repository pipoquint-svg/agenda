...
export function GestanteBookingJourney({ slug }: { slug: 'sabrina-essencial' | 'sabrina-signature' }) {
  ...
  async function saveCustomer() {
    ...
    for (const field of context.fields) {
      if (isDppField(field)) effective[field.id] = dpp
